...
def run_test_sum_of_digits():
    ...
    # Test 3:
    expected = 21
    answer = sum_of_digits(9435)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)
    # Test 4:
    expected = 28
    answer = sum_of_digits(29746)
...
def run_test_digits_in_cube():
    ...
    # Test 2:
    expected = 27
    answer = digits_in_cube(42)
    print('Test 2 expected:', expected)
    print('       actual:  ', answer)
    # Test 3:
    expected = 28
    answer = digits_in_cube(127)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)
...
def run_test_digits_in_power():
    ...
    # Test 2:
    expected = 73
    answer = digits_in_power(8,16)
    print('Test 2 expected:', expected)
    print('       actual:  ', answer)
    # Test 3:
    expected = 59
    answer = digits_in_power(32,7)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)
